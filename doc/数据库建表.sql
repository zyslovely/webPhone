...
CREATE TABLE `TB_Phone_Accessory_Info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `accessoryName` varchar(127) NOT NULL DEFAULT '' COMMENT '配件类型id',
...
CREATE TABLE `TB_Phone_Accessory_Type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `typeName` varchar(127) NOT NULL DEFAULT '' COMMENT '配件种类名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13580 DEFAULT CHARSET=utf8 COMMENT='手机配件种类表'


CREATE TABLE `TB_Phone_Accessory` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `accessoryId` bigint(20) NOT NULL default '0' COMMENT '配件类型id',
  `typeId` bigint(20) NOT NULL default '0' COMMENT '配件种类id',
  PRIMARY KEY (`id`)
