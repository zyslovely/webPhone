...
<p>
   ...
   <#if extPage gt 0><a href="/phone/list/?phoneModel=${phoneModel!""}&toPage=${extPage!0}&inventory=${inventory!0}">上一页</a></#if>
   <#if nextPage lt totalPage+1><a href="/phone/list/?phoneModel=${phoneModel!""}&toPage=${nextPage!0}&inventory=${inventory!0}">下一页</a></#if>
</p>
